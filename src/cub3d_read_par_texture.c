...
ERROR_CODE	read_par_no(char *str, t_par *par, void *mlx)
{
	...
	if (*str != '\0')
	{
		par->tex_no.img = mlx_xpm_file_to_image(mlx, str, &par->tex_no.width,
											&par->tex_no.height);
...
ERROR_CODE	read_par_so(char *str, t_par *par, void *mlx)
{
	...
	if (*str != '\0')
	{
		par->tex_so.img = mlx_xpm_file_to_image(mlx, str, &par->tex_so.width,
												&par->tex_so.height);
...
ERROR_CODE	read_par_we(char *str, t_par *par, void *mlx)
{
	...
	if (*str != '\0')
	{
		par->tex_we.img = mlx_xpm_file_to_image(mlx, str, &par->tex_we.width,
												&par->tex_we.height);
...
ERROR_CODE	read_par_ea(char *str, t_par *par, void *mlx)
{
	...
	if (*str != '\0')
	{
		par->tex_ea.img = mlx_xpm_file_to_image(mlx, str, &par->tex_ea.width,
												&par->tex_ea.height);
...
ERROR_CODE	read_par_spr(char *str, t_par *par, void *mlx)
{
	...
	if (*str != '\0')
	{
		par->tex_spr.img = mlx_xpm_file_to_image(mlx, str, &par->tex_spr.width,
												&par->tex_spr.height);
